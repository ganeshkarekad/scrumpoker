 ...
 */
final class Version20250727063021 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rooms (id INT AUTO_INCREMENT NOT NULL, created_by_id INT NOT NULL, room_key CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, votes_visible TINYINT(1) DEFAULT 0 NOT NULL, UNIQUE INDEX UNIQ_7CA11A96881616B4 (room_key), INDEX IDX_7CA11A96B03A8386 (created_by_id), INDEX idx_room_key (room_key), INDEX idx_room_created_at (created_at), INDEX idx_room_updated_at (updated_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, user_login_id VARCHAR(36) NOT NULL, username VARCHAR(180) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_1483A5E9BC3F045D (user_login_id), INDEX idx_user_username (username), INDEX idx_user_created_at (created_at), INDEX idx_user_login_id (user_login_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
